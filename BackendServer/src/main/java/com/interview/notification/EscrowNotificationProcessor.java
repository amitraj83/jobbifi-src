...
public class EscrowNotificationProcessor extends NotificationProcessor {
   ...
   * basicDBObject = (BasicDBObject) row.get(VARIABLES.NOTIFICATION.DATASTORE.CONTENT); ObjectId iid
   * = new ObjectId( basicDBObject.get(VARIABLES.IID).toString());
   * 
   ...
   * contentMap.put(DATASTORES.INTERVIEW.ESCROW_BALANCE, interview.getEb()); } catch
