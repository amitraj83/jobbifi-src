	...
	public Map<String, Object> handleRequest(Map<Object, Object> data) {
	   ...
	   if(SUB_REQ != null && SUB_REQ.equals(REQUEST_TYPES.MESSAGE_SUB_REQ.GET_JOB_MESSAGE)){
		   ...
		   try{
			   Message msg = new Message();
			   msg = (Message)(data.get("Message"));			   
			   List<Message> list = DataStoreRegistry.getInstance().getMessageStore().getMessage(msg.getParentMessageId());
	   ...
	   } else if(SUB_REQ!=null && SUB_REQ.equals(REQUEST_TYPES.MESSAGE_SUB_REQ.GET_NEW_MESSAGE_COUNT)){
		   try {
	   ...
	   } else if(SUB_REQ!=null && SUB_REQ.equals(REQUEST_TYPES.MESSAGE_SUB_REQ.CHANGE_MESSAGE_STATUS)){
		   try {
