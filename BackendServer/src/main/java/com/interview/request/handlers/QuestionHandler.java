  ...
  public Map<String, Object> handleRequest(Map<Object, Object> data) {
    ...
    if (null != subReq && REQUEST_TYPES.QUESTION_SUB_REQ.SAVE_QUESTION.equals(subReq)) {
      try {
        ...
        && REQUEST_TYPES.QUESTION_SUB_REQ.GET_QUESTIONS_BY_TEST_ID.equals(subReq)) {
      try {
        ...
        List<Question> list = DataStoreRegistry.getInstance().getQuestionStore()
            .getQuestionsByTestId(testId, pageSize, pageNo);
        long count =
            DataStoreRegistry.getInstance().getQuestionStore().getQuestionsCountForTest(testId);
      ...
      try {
        ...
        && REQUEST_TYPES.QUESTION_SUB_REQ.GET_QUESTIONS_FOR_TEST.equals(subReq)) {
      try {
        String testId = (String) data.get(DATASTORES.QUESTION.TEST_ID);
        List<Question> list =
            DataStoreRegistry.getInstance().getQuestionStore().getQuestionsForTest(testId);
        resMap.put("result", list);
        ...
        && REQUEST_TYPES.QUESTION_SUB_REQ.GET_QUESTIONS_COUNT_BY_TEST_ID.equals(subReq)) {
      try {
        String testId = (String) data.get(DATASTORES.QUESTION.TEST_ID);
        long count =
            DataStoreRegistry.getInstance().getQuestionStore().getQuestionsCountForTest(testId);
