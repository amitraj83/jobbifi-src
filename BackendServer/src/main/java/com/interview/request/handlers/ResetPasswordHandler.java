  ...
  public Map<String, Object> handleRequest(Map<Object, Object> data) {
    ...
    try {
      ...
      if (subrequest == 1) {
        ...
        String username = (String) DataStoreRegistry.getInstance().getInterviewerDataStore()
            .getUserInfo(useremail).get(USER.USERNAME);
        if (username != null) {
          String url = Services.getInstance().getGenerateResetPasswordURLService()
              .generateURL(username, useremail);
        ...
        ResetPasswordEntity entity = DataStoreRegistry.getInstance().getResetPasswordDataStore()
