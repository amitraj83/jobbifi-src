...
public class StatsHandler extends RequestHandler{
	...
	public Map<String, Object> handleRequest(Map<Object, Object> data) {
		...
		try {
			...
			long candidateCount = DataStoreRegistry.getInstance().getInterviewerDataStore().getCandidatesCount();
			
			long interviewerCount = DataStoreRegistry.getInstance().getInterviewerDataStore().getInterviewerCount();
