...
public class InterviewLifeCycleTest {
  ...
  public void testDecrypt() {
    ...
    /*
     * try { InterviewerDataStore ids = new InterviewerDataStore(); List<String> iids = new
     * ArrayList<String>(); iids.add("amitraj"); iids.add("Rashad"); iids.add("Rayna");
     * iids.add("Giancarlo");
     * 
     * Map<String, String> map = ids.getPics(iids); Iterator<String> it = map.keySet().iterator();
     * while(it.hasNext()){ String key = it.next(); System.out.println(key+" - "+map.get(key)); }
     * 
     * } catch (RemoteException e) { // TODO Auto-generated catch block e.printStackTrace(); }
     */
    /*
     * try { InterviewDataStore ids = new InterviewDataStore(); List<String> iids = new
     * ArrayList<String>(); iids.add("53e2c98d44ae255b8af6112c");
     * iids.add("53e3e57044aef5a6c6d506d3"); iids.add("5411dbe744aeb4e69a4b6384");
