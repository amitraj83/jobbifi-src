...
public class REQUEST_TYPES {
  ...
  public static final String FILESERVER_UPDATE_INTERVIEW_FILE =
      FILESERVER + "UPDATE_INTERVIEW_FILE";
  public static final String FILESERVER_DOWNLOAD_INTERVIEW_FILE =
      FILESERVER + "DOWNLOAD_INTERVIEW_FILE";
  ...
  public static final String FILESERVER_SAVE_JOB_APPLICATION_FILE =
      FILESERVER + "SAVE_JOB_APPLICATION_FILE";
  ...
  public static final String CREATE_SUPPORT_REQUEST = "CREATE_SUPPORT_REQUEST";
