...
public class MongoDBService {
  ...
  public DBCollection getInterviewerCollection() {
    return mongoService.getDataBase("interviewbackend").getCollection("interviewer");
  }

  public DBCollection getEducationCollection() {
    return mongoService.getDataBase("interviewbackend").getCollection("education");
  }

  public DBCollection getPositionCollection() {
    return mongoService.getDataBase("interviewbackend").getCollection("position");
  }

  public DBCollection getInterviewCollection() {
    return mongoService.getDataBase("interviewbackend").getCollection("interview");
  }

  public DBCollection getJobCollection() {
    return mongoService.getDataBase("interviewbackend").getCollection("job");
  }

  public DBCollection getSkillsCollection() {
    return mongoService.getDataBase("interviewbackend").getCollection("skill");
  }
