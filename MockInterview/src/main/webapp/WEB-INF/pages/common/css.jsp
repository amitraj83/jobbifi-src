...
<link rel="stylesheet" href="<c:url value='/resources/template/css/custom.css' />">
<link rel="stylesheet" href="<c:url value='/css/main.css' />">
<link rel="stylesheet" href="<c:url value='/resources/template/css/responsive.css' />">
<link rel="stylesheet"
      href="<c:url value='https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.5/css/bootstrap-select.min.css' />">

<!--[if IE 9]>
<script src="<c:url value='/resources/template/js/media.match.min.js'/>"></script>
<![endif]-->
