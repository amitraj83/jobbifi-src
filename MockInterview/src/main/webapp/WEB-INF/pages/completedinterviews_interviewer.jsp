...
<head>
    ...
    <title>Completd Interview</title>
</head>
            ...
            <div class="col-md-3">
                <div class="list-group" style="width:100%">
                    ...
                    <a href="<c:url value='currentinterview.do'/>" id="interviewee_current" class="list-group-item">Current
                        Interviews</a>
                    <a href="javascript:void(0);" id="interviewee_completed" class="list-group-item active">Completed
                        Interviews</a>
...
<script type="text/javascript">
    ...
    function loadAllInterview() {
        $.ajax({
            ...
            for (var i = 0; i < resData.MY_INTERVIEW_AS_INTERVIEWER.length; i++) {
                if (getInterviewStatusLiteral(resData.MY_INTERVIEW_AS_INTERVIEWER[i].status) == 'COMPLETED') {
                    var action = "<select class=\"callintervieweeactions\" alt=\"" + resData.MY_INTERVIEW_AS_INTERVIEWER[i].id + "\"></select>";
                    var interviewee_aninterview = '        <tr style="cursor: pointer;" class="interviewee_interview" iid="' + resData.MY_INTERVIEW_AS_INTERVIEWER[i].id + '">' +
                            '            <td> ' + resData.MY_INTERVIEW_AS_INTERVIEWER[i].title + ' </td>' +
                            '            <td> ' + resData.ibid.length + ' </td>' +
                            '            <td> ' + getInterviewStatusLiteral(resData.MY_INTERVIEW_AS_INTERVIEWER[i].status) + ' </td>' +
                            '            <td> ' + prettyDate(new Date(resData.MY_INTERVIEW_AS_INTERVIEWER[i].dt)) + ' </td>' +
                            '        </tr>';
