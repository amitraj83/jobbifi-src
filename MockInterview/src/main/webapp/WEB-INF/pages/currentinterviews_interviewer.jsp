            ...
            <div class="col-md-3">
                <div class="list-group" style="width:100%">
                    ...
                    <a href="<c:url value='openinterview.do'/>" id="interviewee_open" class="list-group-item">Open
                        Interviews</a>
                    <a href="javascript:void(0);" id="interviewee_current" class="list-group-item active">Current
                        Interviews</a>
    ...
    function loadAllInterview() {
        $.ajax({
            ...
            for (var i = 0; i < resData.MY_INTERVIEW_AS_INTERVIEWER.length; i++) {
                if (getInterviewStatusLiteral(resData.MY_INTERVIEW_AS_INTERVIEWER[i].status) == 'IN PROGRESS') {
