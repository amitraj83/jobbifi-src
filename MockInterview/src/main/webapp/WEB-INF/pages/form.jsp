...
<head>
    <link rel="stylesheet" type="text/css"
          href='http://localhost:8080/interviewbackend/css/jquery-ui/pepper-grinder/jquery-ui-1.8.16.custom.css'/>
    <link rel="stylesheet" type="text/css" href='http://localhost:8080/interviewbackend/css/uploadstyle.css'/>

    <script type='text/javascript' src='http://localhost:8080/interviewbackend/js/jquery-1.6.4.min.js'></script>
    <script type='text/javascript'
            src='http://localhost:8080/interviewbackend/js/jquery-ui-1.8.16.custom.min.js'></script>
    <script type='text/javascript' src='http://localhost:8080/interviewbackend/js/util.js'></script>
    <script type='text/javascript'
            src='http://localhost:8080/interviewbackend/js/jquery-fileupload/vendor/jquery.ui.widget.js'></script>
    <script type='text/javascript'
            src='http://localhost:8080/interviewbackend/js/jquery-fileupload/jquery.iframe-transport.js'></script>
    <script type='text/javascript'
            src='http://localhost:8080/interviewbackend/js/jquery-fileupload/jquery.fileupload.js'></script>
...
<div>
    <form id='uploadForm'>
        <fieldset>
            ...
            <input id="upload" type="file" name="file" data-url="file.do" multiple
