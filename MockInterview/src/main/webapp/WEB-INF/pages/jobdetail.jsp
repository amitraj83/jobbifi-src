								...
								<c:choose>
										...
										<div class="panel panel-default">
											<div class="panel-heading">
												<h4 class="panel-title">
													Job Application Details<span class="pull-right">05:21
														PM</span>
												</h4>
											</div>
											<div class="panel-body">
												...
												<c:if test="${not empty uploadedFile}">
													<p>
														<a href="${uploadedFile.URL}" target="_blank">${uploadedFile.originalFileName}</a>
													</p>
												</c:if>
											</div>
										</div>
									...
									<c:otherwise>
										<div class="panel panel-default" id="jobApplicationPanel">
											<span id="errorDoc" name="errorDoc"><code>Please
													select Resume.</code><br /></span> <span id="errorTCover"
												name="errorTCover"> <code>Please enter details
													in Cover letter.</code></span> <span id="coverlettererror"
												name="errorTCover"> <code>Cover letter must be
													alteast 100 characters long.</code></span> <span id="coverTextSize"
												name="coverTextSize"><code> Cover letter is to
													small,At least contains more than 250 words. </code></span> <span
												id="errorFileType" name="errorFileType"><code>Please
													select proper file (.doc,docx,pdf will be accepted).</code></span>

											<div class="panel-heading">
												<h1 class="panel-title" style="font-size: 18px;">Apply
													for this job</h1>
											</div>
											<div class="panel-body">
												<div class="clearfix white-container">
													<form class="form form-horizontal" id="jobApplicationForm">
														...
														<div class="form-group">
															...
															<div class="col-md-10">
																<textarea name="coverLetter" id="coverLetter" rows="5"
																...
																<div class="form-inline">
																	<div class="form-group" style="padding-left: 16px;">
																		<input id="jobapplicationdoc" type="file" name="file"
																			data-url="<c:url value='/aauth/fileupload.do?type=jobapplicationdoc&jobid=${jobid}' />"
																			multiple
																			style="opacity: 0; filter: alpha(opacity : 0);"
																			class="pull-left hide">
																		<button id="attachfile" type="button"
																			class="btn btn-sm btn-info">Upload Resume</button>
																		<img id="fileloader" style="display: none;"
																			alt="Processing..."
																			src="<c:url value="/resources/img/loading.gif" />">
																		<div id="selectedfile" style="clear: both"></div>
																		<input type="hidden" name="cvFileId"
																			id="jobapplicationid">
																	</div>
																</div>
															</div>
