        ...
        <div class="row">
            <div class="col-md-3">
                <div class="list-group" style="width:100%">
                    <a href="<c:url value='allinterview.do'/>" id="interviewee_allinterview"
                       class="list-group-item active">All Interview</a>
    ...
    function loadAllInterview() {
        $.ajax({
            ...
            for (var i = 0; i < resData.MY_INTERVIEW_AS_INTERVIEWER.length; i++) {
                if (getInterviewStatusLiteral(resData.MY_INTERVIEW_AS_INTERVIEWER[i].status) == 'OPEN') {
