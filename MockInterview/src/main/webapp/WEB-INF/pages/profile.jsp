			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 profile-page">
						<div class="row">
							<div class="col-md-4">
								<img class="img-thumbnail profile_img"
									src="<c:url value='/resources/images/face.jpg'/>"
									id="profile_userpic" />
							</div>
							<div class="col-md-8">
								...
								<strong>
									<h1
										style="margin-top: 0px; text-transform: capitalize; font-weight: bold;">
						...
						<div class="row">
							<div class="col-md-12">
								<i class="fa fa-2x fa-tags"></i> &nbsp;<span
									style="font-size: 28px;">Skills</span>
								<div id="skills"></div>
								<hr />
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<i class="fa fa-2x fa-comments"></i> &nbsp;<span
									style="font-size: 28px;">Reviews</span>
