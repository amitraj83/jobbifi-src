        ...
        <div class="row">
            ...
            <div class="col-md-9 page-content">
                ...
                <div class="clearfix white-container">
                    <div id="message"></div>
                    <h1 class="title">Update Interview</h1>
                    <hr>
                    ...
                    <form id="publishInterviewForm" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="${skills}" class="form-control" placeholder="Skills Required" name="skills"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="budget"
                                           placeholder="Price you want to pay" value="${budget}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="experience"
                                           placeholder="Experience of interviewer" value="${experience}">
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.ajax({
            type: "POST",
            url: "<c:url value='editinterview.do'/>",
            data: $("#publishInterviewForm").serialize(),
            async: false
        }).done(function (res) {
            var resData = jQuery.parseJSON(res);
            if (resData!= null) {
                message("Your interview is updated successfully.","success");
                //$('#publishInterviewForm').trigger("reset");
                //$("#selectedfile").html("");
            } else {
                message("Your interview was not updated. Please Try Again.","danger");
            }
