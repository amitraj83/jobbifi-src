	...
	<div class="panel panel-default panel-table">
              <div class="panel-heading" style="color: #fff;background-color: #4cae4c;">
                <div class="row">
                  <div class="col col-xs-6">
                    <h1 class="panel-title" style="    margin-top: 4px;font-size: 32px;">Silver Package | <i class="fa fa-inr" aria-hidden="true"></i>&nbsp;2000</span></h1>
                  </div>
		    ...
		    <sec:authorize access="!isAuthenticated()">  
		      ...
		      <sec:authorize access="isAuthenticated()">
				...
				<input type="hidden" name="amount" value="2000.00" style="display:none" />
